...
- **Broad Host Permissions:** The content script (content.js) is now specifically matched to run only on chat.openai.com, chatgpt.com, gemini.google.com, and claude.ai to address concerns about broad host permissions.
